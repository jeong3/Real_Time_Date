...
<body>
	<table width="600" border=1 align="center">
		...
		<c:forEach items="${list }" var="dto" varStatus="idx">
			<tr>
				<th>${idx.count }</th>
				<th><a href="inquireAnswer.inq?inquireNum=${dto.inquireNum }">${dto.inquireKind }:${dto.inquireSubject }</a></th>
				<th><a href="javascript:goodsDetail('${dto.goodsNum }');">${dto.goodsNum }</a>
				</th>
			</tr>
		</c:forEach>
	</table>
