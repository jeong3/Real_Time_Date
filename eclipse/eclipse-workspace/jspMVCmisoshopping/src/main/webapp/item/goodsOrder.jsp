...
<table width="700" align="center">
	...
	<tr><td> <img src="goods/upload/${list.goodsImage }" width="30"/> </td><td>${list.goodsName }</td>
	<td>${list.cartQty }개 / <fmt:formatNumber value="${list.goodsPrice }" type="currency"/>원</td><td>${list.totalPrice }</td></tr>
	</c:forEach>
				
</table>
<form action="goodsOrder.item" method="post">
<input type="hidden" name="purchaseName" value="${list[0].goodsName }외 ${list.size()-1 }"/>
	...
	<tr><td>
		...
		<td>
			<table width="350">
				...
				<tr><td> 총 결제 금액 </td>
					<td align="right"> <fmt:formatNumber value="${goodsTotalPrice }" type="currency"/> 원 </td></tr>
